...
/*Servicio dependiente del localStorage "id_servicio"*/
getJSON(api_serv+localStorage.getItem("id_servicio")).then(json_servicio=>{
    console.log(json_servicio)
    getJSON(api_perf+json_servicio.id_profesional).then(json_perfil=>{
    ...
    document.getElementById("titulo").innerHTML=json_servicio.titular;
    document.getElementById("descripcion").innerHTML=json_servicio.descripcion;
